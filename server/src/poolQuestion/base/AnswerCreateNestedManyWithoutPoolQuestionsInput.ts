...
@InputType()
class AnswerCreateNestedManyWithoutPoolQuestionsInput {
...
export { AnswerCreateNestedManyWithoutPoolQuestionsInput as AnswerCreateNestedManyWithoutPoolQuestionsInput };
