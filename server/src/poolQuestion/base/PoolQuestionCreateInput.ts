...
class PoolQuestionCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => AnswerCreateNestedManyWithoutPoolQuestionsInput,
  })
  @ValidateNested()
  @Type(() => AnswerCreateNestedManyWithoutPoolQuestionsInput)
  @IsOptional()
  @Field(() => AnswerCreateNestedManyWithoutPoolQuestionsInput, {
    nullable: true,
  })
...
export { PoolQuestionCreateInput as PoolQuestionCreateInput };
